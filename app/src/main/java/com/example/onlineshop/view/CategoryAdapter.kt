...
import com.example.onlineshop.databinding.CategoryItemLayoutBinding
import com.example.onlineshop.model.CategoryModel


interface CategoryAdapterCallback{
    fun onClincItem(item: CategoryModel)
}

data class CategoryAdapter(val items: List<CategoryModel>, val callback: CategoryAdapterCallback): RecyclerView.Adapter<CategoryAdapter.ItemHolder>() {
